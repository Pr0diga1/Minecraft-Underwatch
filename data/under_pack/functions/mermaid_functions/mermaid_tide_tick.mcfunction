...
execute at @e[tag=mermaidtrack,tag=red] run effect give @a[distance=..3,team=uBlue,nbt={OnGround:1b}] jump_boost 1 128 true
...
execute at @e[tag=mermaidtrack,tag=blue] run effect give @a[distance=..3,team=uRed,nbt={OnGround:1b}] jump_boost 1 128 true
