...
execute if score hit mermaidRay matches 0 if entity @s[team=uBlue] positioned ~ ~ ~ as @a[tag=!mermaiddontheal,dx=0,sort=nearest,team=uBlue] at @s positioned ~-0.99 ~-.99 ~-0.99 if entity @s[dx=0] run effect give @s regeneration 3 1 true
execute if score hit mermaidRay matches 0 if entity @s[team=uRed] positioned ~ ~ ~ as @a[tag=!mermaiddontheal,dx=0,sort=nearest,team=uRed] at @s positioned ~-0.99 ~-.99 ~-0.99 if entity @s[dx=0] run effect give @s regeneration 3 1 true
