...
execute if score @s ability3 matches 140 run item replace entity @s hotbar.2 with carrot_on_a_stick{display:{Name:'{"text":"Backstep","color":"green"}'},archerBackstep:1b} 1