...
execute as @s[team=uRed,tag=ungame] unless entity @a[team=uRed,tag=ungame,scores={class=2}] unless entity @s[scores={locked1=2}] unless entity @s[scores={locked2=2}] run scoreboard players set @s class 2
