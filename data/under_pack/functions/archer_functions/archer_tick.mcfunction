...
execute unless entity @s[nbt={Inventory:[{Slot:0b,tag:{archerheavy:1b}}]}] unless entity @s[nbt={Inventory:[{id:"minecraft:chainmail_chestplate"},{Slot:0b}]}] run item replace entity @s hotbar.0 with chainmail_chestplate{CustomModelData:1,Damage:240}
...
execute unless entity @s[nbt={Inventory:[{Slot:1b,tag:{archerlight:1b}}]}] unless entity @s[nbt={Inventory:[{id:"minecraft:chainmail_chestplate"},{Slot:1b}]}] run item replace entity @s hotbar.1 with chainmail_chestplate{CustomModelData:1,Damage:240}
