#summon new arrow
execute at @s run summon arrow ~ ~ ~ {crit:0b,Color:2327041,damage:0.01d,Tags:["SciMove"],CustomPotionEffects:[{Id:1,Amplifier:5b,Duration:45},{Id:8,Amplifier:5b,Duration:45}]}
#set its motion
