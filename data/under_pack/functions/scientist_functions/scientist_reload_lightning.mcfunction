...
execute if score @s ability2 matches 0 run item replace entity @s hotbar.2 with tipped_arrow{CustomModelData:2,display:{Name:'{"text":"Electric Dart","color":"white"}'},scientistLightning:1b,CustomPotionEffects:[{Id:2,Amplifier:255,Duration:30},{Id:8,Amplifier:127b,Duration:30}],CustomPotionColor:16777215} 1
