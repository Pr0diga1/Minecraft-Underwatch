#summon new arrow
execute at @s[tag=blue] run summon arrow ~ ~ ~ {crit:0b,damage:2d,Tags:["sciBolt","blue"],CustomPotionEffects:[{Id:26,Amplifier:1b,Duration:2}]}
execute at @s[tag=red] run summon arrow ~ ~ ~ {crit:0b,damage:2d,Tags:["sciBolt","red"],CustomPotionEffects:[{Id:26,Amplifier:1b,Duration:2}]}
