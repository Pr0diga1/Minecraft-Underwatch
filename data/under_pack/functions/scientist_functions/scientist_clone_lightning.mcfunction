#summon new arrow
execute at @s[tag=blue] run summon arrow ~ ~ ~ {crit:0b,damage:0.01d,Tags:["sciBolt","blue"]}
execute at @s[tag=red] run summon arrow ~ ~ ~ {crit:0b,damage:0.01d,Tags:["sciBolt","red"]}
#set its motion
