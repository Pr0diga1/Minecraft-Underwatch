...
#hits a player
execute if entity @s[team=uRed] positioned ~-.5 ~-.5 ~-.5 as @a[dx=0,team=uBlue] at @s positioned ~-.5 ~-.5 ~-.5 if entity @s[dx=0] run function under_pack:gun_man_functions/gun_ar_hit
execute if entity @s[team=uBlue] positioned ~-.5 ~-.5 ~-.5 as @a[dx=0,team=uRed] at @s positioned ~-.5 ~-.5 ~-.5 if entity @s[dx=0] run function under_pack:gun_man_functions/gun_ar_hit
particle electric_spark ^ ^-.4 ^ 0 0 0 0 100 force
#rerun command
