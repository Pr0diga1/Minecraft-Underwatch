...
item replace entity @s hotbar.2 with carrot_on_a_stick{CustomModelData:53,display:{Name:'{"text":"Grenade Launcher","color":"white"}',Lore:['{"text":"sucky sucky"}']},HideFlags:5,gungl:1b}
