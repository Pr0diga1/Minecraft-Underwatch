...
execute at @s as @s anchored eyes run summon armor_stand ~ ~ ~ {Glowing:0b,Small:1b,Invisible:1b,NoBasePlate:1b,Motion:[0.0,0.0,0.0],Tags:["gun_man_nade"],ArmorItems:[{},{},{},{id:"minecraft:ancient_debris",Count:1b}]}
