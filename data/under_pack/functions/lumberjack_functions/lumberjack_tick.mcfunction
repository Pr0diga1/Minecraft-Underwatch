...
#red
execute as @e[tag=lumberarrow,tag=red] store result entity @s Motion[0] double 0.0015 run scoreboard players get @s LumberjackMotionX
execute as @e[tag=lumberarrow,tag=red] store result entity @s Motion[1] double 0.0015 run scoreboard players get @s LumberjackMotionY
execute as @e[tag=lumberarrow,tag=red] store result entity @s Motion[2] double 0.0015 run scoreboard players get @s LumberjackMotionZ
#blue
execute as @e[tag=lumberarrow,tag=blue] store result entity @s Motion[0] double 0.0015 run scoreboard players get @s LumberjackMotionX
...
execute unless entity @e[tag=lumberarrow] run kill @e[tag=lumberaxe]
