...
#clears the ult
clear @s minecraft:carrot_on_a_stick{lumberdrop:1b}
...
execute if entity @s[team=uRed] if score @s lumberjack_axe_slam matches 30 at @e[tag=lumber_ult,tag=red] run summon creeper ~ ~.2 ~ {Silent:1b,Invulnerable:1b,Fuse:1,ignited:1b,Team:"uRed",CustomName:'{"text":"Axe Throw"}'}
execute if entity @s[team=uBlue] if score @s lumberjack_axe_slam matches 30 at @e[tag=lumber_ult,tag=blue] run summon creeper ~ ~.2 ~ {Silent:1b,Invulnerable:1b,Fuse:1,ignited:1b,Team:"uBlue",CustomName:'{"text":"Axe Throw"}'}
#teleports the giant into the void so that when it is killed you dont see the death animation
execute if entity @s[team=uRed] if score @s lumberjack_axe_slam matches 30 at @s run tp @e[tag=lumber_giant,tag=red] ~ ~-200 ~
execute if entity @s[team=uBlue] if score @s lumberjack_axe_slam matches 30 at @s run tp @e[tag=lumber_giant,tag=blue] ~ ~-200 ~
#kills the giant
execute if entity @s[team=uRed] if score @s lumberjack_axe_slam matches 30 run kill @e[tag=lumber_giant,tag=red]
execute if entity @s[team=uBlue] if score @s lumberjack_axe_slam matches 30 run kill @e[tag=lumber_giant,tag=blue]
#kills the armor_stand
execute if entity @s[team=uRed] if score @s lumberjack_axe_slam matches 30 run kill @e[tag=lumber_ult,tag=red]
execute if entity @s[team=uBlue] if score @s lumberjack_axe_slam matches 30 run kill @e[tag=lumber_ult,tag=blue]
