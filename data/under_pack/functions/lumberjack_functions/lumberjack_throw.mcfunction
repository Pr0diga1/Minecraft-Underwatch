execute if entity @s[team=uRed] at @s run summon armor_stand ^3 ^ ^3 {Tags:["lumberaxemove","red"],NoGravity:1b,DisabledSlots:4144959,Invulnerable:1b,ShowArms:1b,Invisible:1b,Pose:{RightArm:[370f,0f,270f]},HandItems:[{id:"minecraft:iron_axe",Count:1b},{}]}
execute if entity @s[team=uRed] at @s run summon marker ^-3 ^ ^3 {Tags:["lumberaxestill","red"],Invulnerable:1b,NoGravity:1b}
...
execute if entity @s[team=uBlue] at @s run summon armor_stand ^3 ^ ^3 {Tags:["lumberaxemove","blue"],NoGravity:1b,DisabledSlots:4144959,Invulnerable:1b,ShowArms:1b,Invisible:1b,Pose:{RightArm:[270f,0f,270f]},HandItems:[{id:"minecraft:iron_axe",Count:1b},{}]}
execute if entity @s[team=uBlue] at @s run summon marker ^-3 ^ ^3 {Tags:["lumberaxestill","blue"],Invulnerable:1b,NoGravity:1b}
