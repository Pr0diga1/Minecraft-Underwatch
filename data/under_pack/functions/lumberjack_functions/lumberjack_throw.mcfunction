...
execute at @s[team=uRed] run summon minecraft:arrow ~ ~1.5 ~ {Tags:["lumberarrow","red"],CustomName:'{"text":"Axe Throw"}'}
execute at @s[team=uBlue] run summon minecraft:arrow ~ ~1.5 ~ {Tags:["lumberarrow","blue"],CustomName:'{"text":"Axe Throw"}'}
