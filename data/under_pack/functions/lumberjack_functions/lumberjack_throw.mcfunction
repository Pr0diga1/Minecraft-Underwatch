...
execute at @s[team=uRed] run summon minecraft:arrow ~ ~1.5 ~ {Tags:["lumberarrow","red"],CustomName:'{"text":"Axe Throw"}',PierceLevel:10b,damage:6.5d}
execute at @s[team=uBlue] run summon minecraft:arrow ~ ~1.5 ~ {Tags:["lumberarrow","blue"],CustomName:'{"text":"Axe Throw"}',PierceLevel:10b,damage:6.5d}
