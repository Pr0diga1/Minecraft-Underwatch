...
#axe
item replace entity @s hotbar.0 with carrot_on_a_stick{display:{Name:'{"text":"Trusty Axe","color":"dark_gray","bold":true}',Lore:['{"text":"Passed down for generations","color":"dark_purple"}']},Unbreakable:1b,Enchantments:[{}],AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:6.5,Operation:0,UUID:[I;1109363977,-2135735884,-1707744455,1574874286],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-3.6,Operation:0,UUID:[I;363069182,1480476426,-1719579912,406952323],Slot:"mainhand"}],CustomModelData:28,lumberthrow:1b,} 1
#jump
