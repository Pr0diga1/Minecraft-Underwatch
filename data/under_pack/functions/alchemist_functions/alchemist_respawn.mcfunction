...
# Telepot
item replace entity @p hotbar.2 with splash_potion{display:{Name:'{"text":"Telepot","color":"#8753E0","bold":true,"italic":false}'},CustomModelData:1,telepot:1b,CustomPotionColor:16777215} 1
# Ult placeholder
item replace entity @p hotbar.8 with barrier 1
# Armor
