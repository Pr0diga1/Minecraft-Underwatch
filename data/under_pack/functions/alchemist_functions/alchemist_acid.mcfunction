...
# Deal Damage
execute at @e[type=marker,tag=acid,tag=uBlue] if entity @s[team=uBlue] as @a[team=uRed,distance=..1.9] run damage @s 3 magic
execute at @e[type=marker,tag=acid,tag=uRed] if entity @s[team=uRed] as @a[team=uBlue,distance=..1.9] run damage @s 3 magic
