...
# Deal Damage
execute at @e[type=marker,tag=acid,tag=uBlue] if entity @s[team=uBlue] run damage @a[team=uRed,distance=1.1..1.9] 2 magic
execute at @e[type=marker,tag=acid,tag=uRed] if entity @s[team=uRed] run damage @a[team=uBlue,distance=1.1..1.9] 2 magic
execute at @e[type=marker,tag=acid,tag=uBlue] if entity @s[team=uBlue] run damage @a[team=uRed,distance=0.3..1] 3 magic
execute at @e[type=marker,tag=acid,tag=uRed] if entity @s[team=uRed] run damage @a[team=uBlue,distance=0.3..1] 3 magic
execute at @e[type=marker,tag=acid,tag=uBlue] if entity @s[team=uBlue] run damage @a[team=uRed,distance=..0.2] 4 magic
execute at @e[type=marker,tag=acid,tag=uRed] if entity @s[team=uRed] run damage @a[team=uBlue,distance=..0.2] 4 magic
