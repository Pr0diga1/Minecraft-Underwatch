...
execute if entity @s[team=uRed] if entity @e[tag=knighttrack,tag=red] unless entity @e[nbt={Item:{tag:{knightbomb:1b,red:1b}}}] at @e[tag=knighttrack,tag=red] run effect give @a[distance=..3] resistance 1 4 true
...
execute if entity @s[team=uBlue] if entity @e[tag=knighttrack,tag=blue] unless entity @e[nbt={Item:{tag:{knightbomb:1b,blue:1b}}}] at @e[tag=knighttrack,tag=blue] run effect give @a[distance=..3] resistance 1 4 true
