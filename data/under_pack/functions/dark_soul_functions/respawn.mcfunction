...
# Abilities
item replace entity @s hotbar.1 with carrot_on_a_stick{display:{Name:'{"text":"Humanity","color":"#FF4912","bold":true,"italic":false,"underlined":true}'},Unbreakable:1b,CustomModelData:52,humanity:1} 1
