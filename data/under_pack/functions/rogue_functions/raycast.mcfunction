...
# Find target
execute if entity @s[tag=uBlue] unless entity @a[team=uBlue,limit=1,sort=nearest,distance=..2,tag=swap] run tag @a[team=uBlue,limit=1,sort=nearest,distance=..2,tag=!swap] add target
execute if entity @s[tag=uRed] unless entity @a[team=uRed,limit=1,sort=nearest,distance=..2,tag=swap] run tag @a[team=uRed,limit=1,sort=nearest,distance=..2,tag=!swap] add target
