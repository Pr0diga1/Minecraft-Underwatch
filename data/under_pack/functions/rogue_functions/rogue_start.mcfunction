...
# Poison Dart
item replace entity @s hotbar.2 with crossbow{display:{Name:'{"text":"Kill Shot","color":"#BAFF30","bold":true,"italic":false}'},Unbreakable:1b,CustomModelData:2,posiondartrogue:1b,ChargedProjectiles:[{id:"minecraft:tipped_arrow",Count:1b,tag:{CustomPotionColor:16777210}},{},{}],Charged:1b} 1
# Pocket sand
