...
clear @s
# Main weapon
item replace entity @s hotbar.0 with netherite_sword{display:{Name:'{"text":"Netherite Dagger","color":"#472659","bold":true,"italic":false}'},CustomModelData:1,dagger:1b,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:5,Operation:0,UUID:[I;2030465041,-1224523562,-1231173866,-1811458856],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-2.7,Operation:0,UUID:[I;993380834,826688861,-1362153008,-104466871],Slot:"mainhand"}]} 1
# Cloak
