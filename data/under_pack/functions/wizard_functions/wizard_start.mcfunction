...
item replace entity @s armor.feet with leather_boots{display:{color:16777215},Unbreakable:1b,Enchantments:[{id:"minecraft:depth_strider",lvl:2s},{id:"minecraft:blast_protection",lvl:8s}]} 1
