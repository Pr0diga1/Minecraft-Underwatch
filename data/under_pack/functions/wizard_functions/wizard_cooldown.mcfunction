...
execute if score @s ability2 matches 300 run item replace entity @s hotbar.3 with crossbow{display:{Name:'{"text":"The Claws of Rach\'ivalishize","color":"dark_green"}'},Unbreakable:1b,ChargedProjectiles:[{id:"minecraft:firework_rocket",Count:1b},{},{}],Charged:1b} 1

#healing
execute if score @s ability3 matches ..180 run scoreboard players add @s ability3 1
execute if score @s ability3 matches 180 run item replace entity @s hotbar.4 with crossbow{display:{Name:'{"text":"Incolumitas","color":"yellow"}'},Unbreakable:1b,ChargedProjectiles:[{id:"minecraft:firework_rocket",Count:1b},{},{}],Charged:1b} 1
