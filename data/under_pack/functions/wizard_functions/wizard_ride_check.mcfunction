...
execute as @s[scores={ability5=0,wizardFireball=1..}] run scoreboard players set @s ability5 16
execute as @s[scores={ability5=16}] run scoreboard players remove @s wizardFireball 1
execute as @s[scores={ability5=16}] run scoreboard players set @s ability5 15
