...
execute if entity @s[team=uRed] as @e[tag=wizardball,tag=red] store result entity @s Motion[0] double 0.0009 run scoreboard players get @s wizardMotionX
execute if entity @s[team=uRed] as @e[tag=wizardball,tag=red] store result entity @s Motion[1] double 0.0009 run scoreboard players get @s wizardMotionY
execute if entity @s[team=uRed] as @e[tag=wizardball,tag=red] store result entity @s Motion[2] double 0.0009 run scoreboard players get @s wizardMotionZ

execute if entity @s[team=uBlue] as @e[tag=wizardball,tag=blue] store result entity @s Motion[0] double 0.0009 run scoreboard players get @s wizardMotionX
execute if entity @s[team=uBlue] as @e[tag=wizardball,tag=blue] store result entity @s Motion[1] double 0.0009 run scoreboard players get @s wizardMotionY
execute if entity @s[team=uBlue] as @e[tag=wizardball,tag=blue] store result entity @s Motion[2] double 0.0009 run scoreboard players get @s wizardMotionZ
