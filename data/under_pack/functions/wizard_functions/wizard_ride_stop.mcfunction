...
ride @s dismount
#kill chicken
execute as @s[team=uRed] as @e[type=chicken,tag=redWizardRiden] run data merge entity @s {Invulnerable:0b}
execute as @s[team=uBlue] as @e[type=chicken,tag=blueWizardRiden] run data merge entity @s {Invulnerable:0b}
