...
execute unless entity @s[nbt={Inventory:[{Slot:8b,tag:{ninjaUlt:1b}}]}] if score @s ultPercentBuffer matches 100.. run item replace entity @s hotbar.8 with carrot_on_a_stick{display:{Name:'{"text":"Frenzy","color":"purple"}'},ninjaUlt:1b} 1