#damage
execute if entity @a[team=uRed,scores={ninjaUltActive=1}] at @s run summon arrow ~ ~3 ~ {NoGravity:1b,damage:1.8d,Motion:[0.0,-5.0,0.0],Tags:["ninjaDashArrow"]}
execute if entity @a[team=uRed,scores={ninjaUltActive=0}] at @s run summon arrow ~ ~3 ~ {NoGravity:1b,damage:1.4d,Motion:[0.0,-5.0,0.0],Tags:["ninjaDashArrow"]}
