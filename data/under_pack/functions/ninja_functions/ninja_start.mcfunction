clear @s
#Sword
item replace entity @s hotbar.0 with carrot_on_a_stick{CustomModelData:2670001,display:{Name:'{"text":"Katana","color":"dark_gray"}',Lore:['{"text":"Right Click to dash"}']},Unbreakable:1b,ninjaDash:1b,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:4.5,Operation:0,UUID:[I;-303483349,-628079732,-1599542459,-1119264089],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-2.4,Operation:0,UUID:[I;189918499,1882276604,-1159240676,932653466],Slot:"mainhand"}]} 1
#Toss
item replace entity @s hotbar.1 with carrot_on_a_stick{CustomModelData:2670002,display:{Name:'{"text":"Shuriken Throw","color":"blue"}'},ninjaToss:1b} 1
#Hyperventilate
item replace entity @s hotbar.2 with carrot_on_a_stick{CustomModelData:2670003,display:{Name:'{"text":"Brass Knuckles","color":"gold"}',Lore:['{"text":"Right Click to hyperventilate"}']},ninjaHyperventilate:1b,AttributeModifiers:[{AttributeName:"generic.attack_damage",Name:"generic.attack_damage",Amount:2,Operation:0,UUID:[I;-313458390,-1808840175,-1185663256,636532485],Slot:"mainhand"},{AttributeName:"generic.attack_speed",Name:"generic.attack_speed",Amount:-2,Operation:0,UUID:[I;971141352,1171998355,-1798810994,-675089356],Slot:"mainhand"}]} 1
#armor
