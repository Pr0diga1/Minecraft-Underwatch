...
#healies
execute if entity @s[team=uRed] run item replace entity @s hotbar.2 with snowball{display:{Name:'{"text":"Ibuprofen","color":"blue"}'},enginedrug:1b,red:1b} 4
execute if entity @s[team=uBlue] run item replace entity @s hotbar.2 with snowball{display:{Name:'{"text":"Ibuprofen","color":"blue"}'},enginedrug:1b,blue:1b} 4
#WD-40
...
scoreboard players set engineerUltPercent modifier 45
#goal is 4500