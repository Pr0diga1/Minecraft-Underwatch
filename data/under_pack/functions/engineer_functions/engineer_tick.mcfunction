...
execute if score @s ability3 matches 180 run item replace entity @s hotbar.3 with carrot_on_a_stick{CustomModelData:43,display:{Name:'{"text":"Cardboard and Duct Tape","color":"gold"}'},enginewall:1b} 1

execute if score @s ability4 matches ..220 run scoreboard players add @s ability4 1 
execute if score @s ability4 matches 220 run item replace entity @s hotbar.4 with carrot_on_a_stick{CustomModelData:49,display:{Name:'{"text":"WD-40","color":"dark_blue"}'},engineslip:1b} 1
