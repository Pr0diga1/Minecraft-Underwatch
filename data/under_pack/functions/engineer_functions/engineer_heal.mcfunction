...
execute if entity @s[team=uRed] if score @s ability2 matches 70 run give @s snowball{CustomModelData:3,display:{Name:'{"text":"Ibuprofen","color":"blue"}'},enginedrug:1b,red:1b} 1
execute if entity @s[team=uBlue] if score @s ability2 matches 70 run give @s snowball{CustomModelData:3,display:{Name:'{"text":"Ibuprofen","color":"blue"}'},enginedrug:1b,blue:1b} 1
