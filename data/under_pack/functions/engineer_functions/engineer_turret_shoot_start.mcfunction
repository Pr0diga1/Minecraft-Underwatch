...
tp @s[tag=redEngineerTurret] ~ ~ ~ facing entity @a[team=uBlue,limit=1,sort=nearest] eyes
tp @s[tag=blueEngineerTurret] ~ ~ ~ facing entity @a[team=uRed,limit=1,sort=nearest] eyes
