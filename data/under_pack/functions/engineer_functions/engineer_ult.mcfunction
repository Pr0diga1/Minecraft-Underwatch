...
execute if entity @s[team=uRed] at @e[tag=enginehole,tag=red] if score @s engineer_ult matches 1..98 as @a[distance=..5,team=uBlue] run tag @s add graved
...
execute if entity @s[team=uBlue] at @e[tag=enginehole,tag=blue] if score @s engineer_ult matches 1..98 as @a[distance=..5,team=uRed] run tag @s add graved
