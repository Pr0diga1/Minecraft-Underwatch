...
# Abilities
item replace entity @s hotbar.1 with goat_horn[consumable={consume_seconds:10000,animation:"toot_horn",sound:"minecraft:ambient.basalt_deltas.additions",has_consume_particles:false},custom_data={megaphone:true},item_name='{"bold":true,"color":"light_purple","italic":false,"text":"Megaphone"}'] 1
