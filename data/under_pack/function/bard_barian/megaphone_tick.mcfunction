...
execute if entity @s[team=uBlue] as @e[type=marker,tag=NoteL,tag=uBlue] run return run function under_pack:bard_barian/lovers_lament_note_tick
...
execute if entity @s[team=uRed] as @e[type=marker,tag=NoteL,tag=uRed] run return run function under_pack:bard_barian/lovers_lament_note_tick
