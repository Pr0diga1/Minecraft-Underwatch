...
# Armor
item replace entity @s armor.legs with leather_leggings[dyed_color=7689249,trim={material:"minecraft:redstone",pattern:"minecraft:snout"},attribute_modifiers=[{id:"max_health",type:"max_health",amount:6,operation:"add_value"},{id:"water_movement_efficiency",type:"water_movement_efficiency",amount:0.67,operation:"add_value"}],enchantments={"minecraft:blast_protection":8},enchantment_glint_override=false,unbreakable={}] 1
