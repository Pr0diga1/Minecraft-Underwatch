...
execute if entity @s[team=uRed] if entity @a[tag=target,team=uRed] run item modify entity @s hotbar.2 under_pack:rogue/swap_target
...
#rerun command
execute if entity @s[team=uBlue] unless entity @a[tag=target,team=uBlue] if score distance buffer matches ..180 positioned ^ ^ ^.5 run function under_pack:rogue_functions/raycast
execute if entity @s[team=uRed] unless entity @a[tag=target,team=uRed] if score distance buffer matches ..180 positioned ^ ^ ^.5 run function under_pack:rogue_functions/raycast