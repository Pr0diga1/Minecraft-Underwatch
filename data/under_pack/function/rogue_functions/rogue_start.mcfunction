...
clear @s
# Main weapon
item replace entity @s hotbar.0 with netherite_sword[custom_name='{"bold":true,"color":"#472659","italic":false,"text":"Netherite Dagger"}',custom_data={dagger:1b},unbreakable={show_in_tooltip:false},attribute_modifiers=[{id:"armor",type:"attack_damage",amount:1,operation:"add_value",slot:"mainhand"},{id:"armor",type:"attack_speed",amount:-2.7,operation:"add_value",slot:"mainhand"}]] 1
# Cloak
