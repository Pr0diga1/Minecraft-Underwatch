# Cooldown init
item replace entity @s hotbar.3 with barrier[custom_model_data=9]
...
particle dust{color:[0.922,0.922,0.553],scale:2} ^ ^1 ^0.5 0.2 0.2 0.2 1 15 normal
particle dust{color:[0.922,0.922,0.553],scale:2} ^ ^1 ^1 0.5 0.5 0.5 1 25 normal
particle dust{color:[0.922,0.922,0.553],scale:2} ^ ^1 ^1.5 0.7 0.7 0.7 1 30 normal
