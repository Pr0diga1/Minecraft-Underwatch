...
execute as @s[scores={ability5=0,wizardFireball=1..}] run scoreboard players set @s ability5 12
execute as @s[scores={ability5=12}] run scoreboard players remove @s wizardFireball 1
execute as @s[scores={ability5=12}] run scoreboard players set @s ability5 9
...
advancement revoke @s only under_pack:wizard/ride