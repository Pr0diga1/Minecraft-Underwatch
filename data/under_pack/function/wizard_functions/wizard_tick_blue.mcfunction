...
#fireball w/ eye
execute as @e[type=item,nbt={Item:{id:"minecraft:ender_eye",count:1,components:{"minecraft:custom_data":{wizardFire:1b,blue:1b}}}}] at @s on origin as @s[scores={wizardFireball=1..}] run function under_pack:wizard_functions/wizard_fireball_blue
...
execute as @s[nbt={Inventory:[{id:"minecraft:air"},{Slot:0b}]}] run item replace entity @s hotbar.0 with carrot_on_a_stick[custom_name='{"bold":true,"color":"light_purple","italic":true,"text":"Agicmay Andway"}',lore=['"Crafted from the tree of Lofaktar"'],custom_model_data=45,custom_data={wizardWand:1b,blue:1b}] 1
execute as @s[nbt={Inventory:[{id:"minecraft:air"},{Slot:1b}]}] run item replace entity @s hotbar.1 with ender_eye[custom_name='{"bold":true,"color":"gold","italic":true,"text":"Become Fire"}',lore=['"\'fireball\' - Pitbull"'],custom_data={wizardFire:1b,blue:1b}] 1
