...
execute store result entity @s Motion[0] double 0.00035 run scoreboard players get WizardFireballX2 buffer
execute store result entity @s Motion[1] double 0.00035 run scoreboard players get WizardFireballY2 buffer
execute store result entity @s Motion[2] double 0.00035 run scoreboard players get WizardFireballZ2 buffer
