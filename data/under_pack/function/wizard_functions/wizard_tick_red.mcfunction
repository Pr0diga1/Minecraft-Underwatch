...
execute as @s[team=uRed,nbt={Inventory:[{id:"minecraft:air"},{Slot:1b}]}] run item replace entity @s hotbar.1 with ender_eye[custom_name='{"bold":true,"color":"gold","italic":true,"text":"Become Fire"}',lore=['"\'fireball\' - Pitbull"'],custom_data={wizardFire:1b,red:1b}] 1
