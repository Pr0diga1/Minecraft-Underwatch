...
#claws
execute if score @s ability2 matches 1 run item replace entity @s hotbar.2 with carrot_on_a_stick[custom_name={"color":"dark_green","text":"The Claws of Rachivalishize"},unbreakable={},custom_data={wizardClaws:1b}] 1
