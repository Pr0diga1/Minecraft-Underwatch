execute as @e[type=armor_stand,tag=gun_man_nade,limit=1,sort=nearest] at @e[type=armor_stand,tag=gun_man_nade,limit=1,sort=nearest] run particle dripping_dripstone_lava ^ ^ ^ 2 2 2 10 1000 force
