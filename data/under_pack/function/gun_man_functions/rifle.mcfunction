...
#
scoreboard players set counter buffer 0
...
execute if score @s riflebuffer matches 0 anchored eyes positioned ^ ^ ^ run function under_pack:gun_man_functions/riflecast
