...
execute if score @s ability2 matches 1 run item replace entity @s hotbar.1 with carrot_on_a_stick[custom_name='{"color":"blue","text":"Shuriken Throw"}',custom_model_data=24,custom_data={ninjaToss:1b}] 1
