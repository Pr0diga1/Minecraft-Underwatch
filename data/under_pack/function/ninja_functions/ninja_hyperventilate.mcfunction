#new item
item replace entity @s hotbar.2 with wooden_shovel[custom_name='{"color":"gold","text":"Brass Knuckles"}',lore=['"Right click to hyperventilate"'],damage=1,custom_model_data=25,attribute_modifiers=[{id:"armor",type:"generic.attack_damage",amount:3.25,operation:"add_value",slot:"mainhand"},{id:"armor",type:"generic.attack_speed",amount:150,operation:"add_value",slot:"mainhand"}]] 1
