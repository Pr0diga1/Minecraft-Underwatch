...
execute at @s as @e[type=arrow,tag=!tossMoved,tag=nared] rotated as @a[team=uRed,scores={class=6},limit=1,sort=nearest] run function under_pack:ninja_functions/ninja_toss_velo
execute at @s as @e[type=arrow,tag=!tossMoved,tag=nablue] rotated as @a[team=uBlue,scores={class=6},limit=1,sort=nearest] run function under_pack:ninja_functions/ninja_toss_velo
