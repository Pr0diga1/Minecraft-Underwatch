...
execute as @s[nbt={Inventory:[{Slot:1b,components:{"minecraft:custom_data":{ninjaToss:1b}}}],SelectedItem:{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{ninjaToss:1b}}}},scores={reset=1..}] if score @s ability2 matches 180.. run function under_pack:ninja_functions/ninja_toss
execute as @s[nbt={Inventory:[{Slot:2b,components:{"minecraft:custom_data":{ninjaHyperventilate:1b}}}],SelectedItem:{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{ninjaHyperventilate:1b}}}},scores={reset=1..}] if score @s ability3 matches 300.. run function under_pack:ninja_functions/ninja_hyperventilate
