...
execute at @s run summon arrow ~ ~ ~ {damage:0.1d,crit:0b,Tags:["SciHeal"],item:{id:"minecraft:tipped_arrow",components:{"minecraft:potion_contents":{custom_color:16768257,custom_effects:[{id:"minecraft:regeneration",amplifier:4b,duration:30,show_particles:0b}]}}}}
