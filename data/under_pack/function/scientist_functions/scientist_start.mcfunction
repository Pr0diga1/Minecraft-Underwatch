...
#bow into offhand
item replace entity @s weapon.offhand with bow[unbreakable={show_in_tooltip:false}] 1
#damage arrows
...
#scientist
item replace entity @s armor.feet with iron_boots[attribute_modifiers=[{id:"explosion_knockback_resistance",type:"explosion_knockback_resistance",amount:-1.2,operation:"add_value",slot:"any"}],unbreakable={show_in_tooltip:false},enchantments={levels:{"minecraft:blast_protection":8,"minecraft:protection":2,"minecraft:depth_strider":2}}] 1
...
item replace entity @s armor.chest with leather_chestplate[custom_name='"Jetpack"',unbreakable={show_in_tooltip:false},attribute_modifiers=[{id:"armor",type:"armor",amount:0,operation:"add_value",slot:"chest"}],dyed_color=16777215] 1
