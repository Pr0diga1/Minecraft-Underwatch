execute as @s[scores={class=1}] at @s run function under_pack:alchemist_functions/alchemist_tick
...
execute as @s[scores={class=8}] at @s run function under_pack:rogue_functions/rogue_tick
...
execute as @s[scores={class=14}] run function under_pack:gun_man_functions/gun_tick