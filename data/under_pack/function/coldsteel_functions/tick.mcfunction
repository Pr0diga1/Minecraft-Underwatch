...
#blast
execute if entity @e[type=item,nbt={Item:{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_data":{coldtp:1b, red:1b}}}}] if entity @s[team=uRed] run function under_pack:coldsteel_functions/blast_red
execute if entity @e[type=item,nbt={Item:{id:"minecraft:carrot_on_a_stick",count:1,components:{"minecraft:custom_data":{coldtp:1b, blue:1b}}}}] if entity @s[team=uBlue] run function under_pack:coldsteel_functions/blast_blue
