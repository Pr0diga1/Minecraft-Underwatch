#carrot on stick
execute as @s[nbt={Inventory:[{Slot:1b,components:{"minecraft:custom_data":{elementalWind:1b}}}],SelectedItem:{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{elementalWind:1b}}}},scores={reset=1..}] if score @s elementalBar matches 300.. run function under_pack:elemental_functions/elemental_wind
execute as @s[nbt={Inventory:[{Slot:2b,components:{"minecraft:custom_data":{elementalWater:1b}}}],SelectedItem:{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{elementalWater:1b}}}},scores={reset=1..}] if score @s elementalBar matches 1.. if score @s elementalWaterState matches 0 at @s anchored eyes positioned ^ ^ ^ anchored feet run function under_pack:elemental_functions/elemental_water_create
execute as @s[nbt={Inventory:[{Slot:2b,components:{"minecraft:custom_data":{elementalWater:1b}}}],SelectedItem:{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{elementalWater:1b}}}},scores={reset=1..}] if score @s elementalBar matches 1.. if score @s elementalWaterState matches 1 run function under_pack:elemental_functions/elemental_water_destroy
execute as @s[nbt={Inventory:[{Slot:3b,components:{"minecraft:custom_data":{elementalEarth:1b}}}],SelectedItem:{id:"minecraft:carrot_on_a_stick",components:{"minecraft:custom_data":{elementalEarth:1b}}}},scores={reset=1..}] if score @s elementalBar matches 240.. at @s run function under_pack:elemental_functions/elemental_earth
