...
# earth
item replace entity @s hotbar.3 with pitcher_pod[custom_name={"color":"gray","text":"Earth"},custom_data={elementalEarth:true},consumable={consume_seconds:999999999,animation:"spear"}] 1
