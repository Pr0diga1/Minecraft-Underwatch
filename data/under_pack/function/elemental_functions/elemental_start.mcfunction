...
# water
item replace entity @s hotbar.2 with heart_of_the_sea[custom_name={"color":"dark_aqua","text":"Water"},custom_data={elementalWater:true},consumable={consume_seconds:999999999,animation:"spear"}] 1

# earth
item replace entity @s hotbar.3 with cobblestone[custom_name={"color":"gray","text":"Earth"},custom_data={elementalEarth:true},consumable={consume_seconds:999999999,animation:"spear"}] 1
...
scoreboard players set ElementalFireTiming constant 9
