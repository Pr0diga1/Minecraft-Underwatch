...
item replace entity @s hotbar.1 with carrot_on_a_stick[custom_name='{"color":"white","text":"Wind"}',custom_data={elementalWind:1b},enchantments={levels:{"under_pack:wind":1}}] 1
item replace entity @s hotbar.2 with carrot_on_a_stick[custom_name='{"color":"dark_aqua","text":"Water"}',custom_data={elementalWater:1b},enchantments={levels:{"under_pack:water":1}}] 1
item replace entity @s hotbar.3 with carrot_on_a_stick[custom_name='{"color":"gray","text":"Earth"}',custom_data={elementalEarth:1b},enchantments={levels:{"under_pack:earth":1}}] 1
