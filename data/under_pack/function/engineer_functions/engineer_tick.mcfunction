...
#turret
item replace entity @s[scores={ability7=0}] hotbar.6 with ender_eye[custom_name='{"color":"dark_red","text":"Turret"}',custom_model_data=43,custom_data={enginedrug:1b}] 2
