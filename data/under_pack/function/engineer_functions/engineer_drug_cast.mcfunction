...
#cooldown
execute as @s[team=uRed] if entity @a[tag=redViagraTarget] run scoreboard players set @s ability5 200
execute as @s[team=uBlue] if entity @a[tag=blueViagraTarget] run scoreboard players set @s ability5 200
