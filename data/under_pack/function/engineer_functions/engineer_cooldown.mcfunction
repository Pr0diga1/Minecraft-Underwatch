...
#healies ability2
execute if score @s ability2 matches 1 if entity @s[team=uRed] run item replace entity @s hotbar.2 with snowball[custom_name={"color":"blue","text":"5000mg of Ibuprofen"},custom_data={enginedrug:1b,red:1b},item_model="blaze_spawn_egg"] 1
execute if score @s ability2 matches 1 if entity @s[team=uBlue] run item replace entity @s hotbar.2 with snowball[custom_name={"color":"blue","text":"5000mg of Ibuprofen"},custom_data={enginedrug:1b,blue:1b},item_model="blaze_spawn_egg"] 1
execute if score @s ability2 matches 1.. run experience add @s 17 points
...
execute if score @s ability3 matches 1 run item replace entity @s hotbar.1 with shears[enchantments={"minecraft:knockback":3},custom_name={"bold":true,"color":"gray","text":"Wrench"},custom_data={wrench:1b}] 1
