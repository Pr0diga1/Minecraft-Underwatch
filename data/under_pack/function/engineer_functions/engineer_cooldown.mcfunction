...
execute if score @s ability3 matches 0 run item replace entity @s hotbar.1 with shears[custom_name='{"bold":true,"color":"gray","text":"Wrench"}',custom_data={wrench:1b}] 1
