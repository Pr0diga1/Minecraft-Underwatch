...
execute if entity @s[team=uBlue] as @a[team=uRed,distance=..8] run damage @s 7 player_attack
execute if entity @s[team=uRed] as @a[team=uBlue,distance=..8] run damage @s 7 player_attack
