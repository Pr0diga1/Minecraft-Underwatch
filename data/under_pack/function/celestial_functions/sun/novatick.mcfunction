...
execute at @s run function under_pack:celestial_functions/sun/particle

$execute at @s[team=uRed] run particle dust{color:[1.000,$(red),0.000],scale:1} ~ ~ ~ .75 1 .75 .001 10 normal
$execute at @s[team=uBlue] run particle dust{color:[1.000,$(blue),0.000],scale:1} ~ ~ ~ .75 1 .75 .001 10 normal