item replace entity @s[team=uRed] hotbar.0 with golden_sword[minimum_attack_charge=0.75,attribute_modifiers=[{id:"attack_damage",type:"attack_damage",amount:2,operation:"add_value"},{id:"attack_speed",type:"attack_speed",amount:-2.75,operation:"add_value"}],custom_data={celeswap:1b, celeshine:1b,red:1b},custom_name={"color":"yellow","text":"Shine"},unbreakable={}] 1
item replace entity @s[team=uRed] hotbar.1 with carrot_on_a_stick[custom_data={celeswap:1b, celenova:1b,red:1b},custom_name={"color":"dark_purple","text":"Supernova"},unbreakable={},item_model="sunflower"] 1
item replace entity @s[team=uRed] hotbar.2 with carrot_on_a_stick[custom_data={celeswap:1b, celeset:1b,red:1b},custom_name={"color":"gold","text":"Sunset"},unbreakable={},item_model="ochre_froglight"] 1
...
item replace entity @s[team=uBlue] hotbar.1 with carrot_on_a_stick[custom_data={celeswap:1b, celenova:1b,blue:1b},custom_name={"color":"dark_purple","text":"Supernova"},unbreakable={},item_model="sunflower"] 1
item replace entity @s[team=uBlue] hotbar.2 with carrot_on_a_stick[custom_data={celeswap:1b, celeset:1b,blue:1b},custom_name={"color":"gold","text":"Sunset"},unbreakable={},item_model="ochre_froglight"] 1
