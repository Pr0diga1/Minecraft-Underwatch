...
execute if score @s ability2 matches 1 run item replace entity @s hotbar.2 with carrot_on_a_stick[custom_data={celeswap:1b, celeset:1b},custom_name='{"color":"gold","text":"Sunset"}',unbreakable={}] 1
