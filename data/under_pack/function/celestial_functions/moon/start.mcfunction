clear @s
item replace entity @s[team=uRed] hotbar.0 with snowball[custom_data={celeswap:1b,celedrop:1b,red:1b},custom_name={"color":"dark_blue","text":"Lunar Drop"},item_model="allay_spawn_egg"] 1
item replace entity @s[team=uBlue] hotbar.0 with snowball[custom_data={celeswap:1b,celedrop:1b,blue:1b},custom_name={"color":"dark_blue","text":"Lunar Drop"},item_model="allay_spawn_egg"] 1

item replace entity @s[team=uRed] hotbar.1 with carrot_on_a_stick[custom_data={celeswap:1b, celefull:1b,red:1b},custom_name={"color":"gray","text":"Full Moon"},unbreakable={},item_model="sea_lantern"] 1
item replace entity @s[team=uRed] hotbar.2 with heart_of_the_sea[consumable={consume_seconds:100000000,animation:"bow",sound:"block.note_block.bass",has_consume_particles:false},custom_data={celeswap:1b, celetidal:true,red:1b},custom_name={"color":"dark_purple","text":"Tidal Pull"},unbreakable={},item_model="tide_armor_trim_smithing_template"] 1

item replace entity @s[team=uBlue] hotbar.1 with carrot_on_a_stick[custom_data={celeswap:1b, celefull:1b,blue:1b},custom_name={"color":"gray","text":"Full Moon"},unbreakable={},item_model="sea_lantern"] 1
item replace entity @s[team=uBlue] hotbar.2 with heart_of_the_sea[consumable={consume_seconds:100000000,animation:"bow",sound:"block.note_block.bass",has_consume_particles:false},custom_data={celeswap:1b, celetidal:true,blue:1b},custom_name={"color":"dark_purple","text":"Tidal Pull"},unbreakable={},item_model="tide_armor_trim_smithing_template"] 1
