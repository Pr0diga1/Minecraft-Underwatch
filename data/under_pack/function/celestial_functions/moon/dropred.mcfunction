...
execute if score @s ability3 matches 1 run item replace entity @s hotbar.0 with snowball[custom_data={celeswap:1b,celedrop:1b,red:1b},custom_name={"color":"dark_blue","text":"Lunar Drop"},item_model="allay_spawn_egg"]
