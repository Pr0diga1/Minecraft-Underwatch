...
execute as @e[tag=celetrack,tag=red] at @s unless entity @e[predicate=under_pack:celestial/lunardropred] as @a[team=uBlue,distance=..2.5] run damage @s 3.5 player_attack by @a[team=uRed,scores={class=20},limit=1]
#kills the marker
