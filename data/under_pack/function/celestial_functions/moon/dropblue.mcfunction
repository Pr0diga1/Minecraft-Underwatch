...
execute if entity @e[tag=celetrack,tag=blue] unless entity @e[predicate=under_pack:celestial/lunardropblue] as @a[team=uRed,distance=..2.25] run damage @s 3.5 player_attack by @a[team=uBlue,scores={class=20},limit=1]
#kills the marker
