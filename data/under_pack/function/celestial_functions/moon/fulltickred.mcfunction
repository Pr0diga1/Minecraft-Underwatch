tp @s ^ ^ ^.2
execute as @a[team=uRed,distance=..4,nbt=!{active_effects:[{id:"minecraft:regeneration"}]}] unless entity @s[scores={class=20}] run effect give @s regeneration 1 3 true
