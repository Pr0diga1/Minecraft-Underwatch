...
execute if score @s[team=uRed] ability4 matches 1 run item replace entity @s hotbar.1 with carrot_on_a_stick[custom_data={celeswap:1b, celefull:1b,red:1b},custom_name={"color":"gray","text":"Full Moon"},unbreakable={},item_model="sea_lantern"] 1
execute if score @s[team=uBlue] ability4 matches 1 run item replace entity @s hotbar.1 with carrot_on_a_stick[custom_data={celeswap:1b, celefull:1b,blue:1b},custom_name={"color":"gray","text":"Full Moon"},unbreakable={},item_model="sea_lantern"] 1
