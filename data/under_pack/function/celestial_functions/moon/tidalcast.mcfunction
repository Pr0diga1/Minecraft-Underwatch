...
#hits a player
execute if entity @s[team=uRed] positioned ~-1 ~-1 ~-1 as @a[dx=2,dy=2,dz=2,team=uRed,limit=1,sort=nearest,tag=!me] run scoreboard players reset @a[team=uRed,scores={class=20}] celetidal
