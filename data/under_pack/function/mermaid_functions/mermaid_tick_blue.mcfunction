#particle
execute at @a[tag=mermaidhitbyheal,team=uBlue] run particle bubble ~ ~1.3 ~ .17 .3 .17 .1 5 force @s
#mist regen
...
#perch stuff
execute if score @s mermaidperch matches ..-2 run scoreboard players operation @s mermaidperch = mermaidBluePerchConstant constant
