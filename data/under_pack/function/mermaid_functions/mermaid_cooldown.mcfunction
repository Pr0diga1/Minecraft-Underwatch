...
execute if entity @s[team=uBlue] if score @s ability1 matches 1 run item replace entity @s hotbar.2 with lingering_potion[custom_name='{"color":"blue","text":"Tide Pool"}',custom_data={mermaidtide:1b},potion_contents={custom_color:3366143,custom_effects:[{id:"minecraft:luck",amplifier:0,duration:1}]}] 1 
