clear @s
item replace entity @s hotbar.0 with carrot_on_a_stick[custom_name={"color":"dark_aqua","text":"Poseidon\s Back Scratcher"},unbreakable={},custom_data={mermaidburst:1b},attribute_modifiers=[{id:"speed",type:"attack_speed",amount:-2.3,operation:"add_value",slot:"mainhand"},{id:"damage",type:"attack_damage",amount:1.2,operation:"add_value",slot:"mainhand"}]] 1
...
item replace entity @s hotbar.2 with carrot_on_a_stick[custom_name={"color":"aqua","text":"Dive"},unbreakable={},custom_data={mermaiddive:1b}] 1
