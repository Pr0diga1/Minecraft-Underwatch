clear @s
item replace entity @s hotbar.0 with carrot_on_a_stick[custom_name='{"color":"dark_aqua","text":"Poseidon\'s Back Scratcher"}',unbreakable={show_in_tooltip:false},custom_model_data=0,custom_data={mermaidburst:1b},attribute_modifiers=[{id:"speed",type:"generic.attack_speed",amount:-2.3,operation:"add_value",slot:"mainhand"},{id:"damage",type:"generic.attack_damage",amount:1.2,operation:"add_value",slot:"mainhand"}]] 1
