clear @s
item replace entity @s hotbar.0 with carrot_on_a_stick[custom_name={"color":"dark_aqua","text":"Poseidon's Back Scratcher"},unbreakable={},custom_data={mermaidburst:1b},attribute_modifiers=[{id:"speed",type:"attack_speed",amount:-2.2,operation:"add_value",slot:"mainhand"},{id:"damage",type:"attack_damage",amount:1.2,operation:"add_value",slot:"mainhand"}],item_model="trident"] 1
