...
item replace entity @s hotbar.1 with diamond_sword[consumable={consume_seconds:10000,animation:"brush"},custom_name={"color":"dark_blue","text":"Nautical Mist"},custom_data={mermaidmist:1b}] 1
