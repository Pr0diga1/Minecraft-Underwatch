...
execute if score hit mermaidRay matches 0 if entity @s[team=uBlue] positioned ~-0.42 ~-.8 ~-0.42 as @a[team=uBlue,dx=0,sort=nearest,tag=!mermaiddontheal] at @s positioned ~-0.69 ~-.69 ~-0.69 if entity @s[dx=0] run function under_pack:mermaid_functions/mermaid_hitbyheal
execute if score hit mermaidRay matches 0 if entity @s[team=uRed] positioned ~-0.42 ~-.8 ~-0.42 as @a[team=uRed,dx=0,sort=nearest,tag=!mermaiddontheal] at @s positioned ~-0.69 ~-.69 ~-0.69 if entity @s[dx=0] run function under_pack:mermaid_functions/mermaid_hitbyheal
