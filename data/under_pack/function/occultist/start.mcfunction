...
# Share Wounds
item replace entity @s hotbar.2 with rib_armor_trim_smithing_template[consumable={consume_seconds:1,animation:"block",sound:"minecraft:block.portal.ambient",has_consume_particles:false},custom_data={sharewounds:true},custom_name='{"bold":true,"color":"dark_red","italic":false,"text":"Share Wounds"}'] 1

# Spatial Warp
item replace entity @s hotbar.3 with spire_armor_trim_smithing_template[consumable={consume_seconds:2,animation:"block",sound:"block.portal.travel",has_consume_particles:false},custom_data={spacewarp:true},custom_name='[{"color":"#2100A3","text":"S"},{"color":"#2B00A3","text":"p"},{"color":"#3500A3","text":"a"},{"color":"#3E00A3","text":"t"},{"color":"#4800A3","text":"i"},{"color":"#5200A3","text":"a"},{"color":"#5C00A3","text":"l "},{"color":"#6600A3","text":"W"},{"color":"#7000A3","text":"a"},{"color":"#7900A3","text":"r"},{"color":"#8D00A3","text":"p"}]'] 1
