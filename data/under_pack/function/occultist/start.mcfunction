...
item replace entity @s armor.feet with leather_boots[unbreakable={show_in_tooltip:false},enchantments={levels:{"minecraft:blast_protection":8,"minecraft:depth_strider":2}},attribute_modifiers=[{id:"armor",type:"armor",amount:6,operation:"add_value"},{id:"explosion_knockback_resistance",type:"explosion_knockback_resistance",amount:-1.2,operation:"add_value",slot:"any"}],dyed_color=4483814,trim={material:"minecraft:redstone",pattern:"minecraft:wild",show_in_tooltip:false}] 1
item replace entity @s armor.legs with leather_leggings[unbreakable={show_in_tooltip:false},dyed_color=4483814,trim={material:"minecraft:redstone",pattern:"minecraft:dune",show_in_tooltip:false}] 1
item replace entity @s armor.chest with leather_chestplate[unbreakable={show_in_tooltip:false},dyed_color=4483814,trim={material:"minecraft:redstone",pattern:"minecraft:coast",show_in_tooltip:false}] 1
