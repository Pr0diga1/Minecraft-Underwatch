...
item replace entity @s hotbar.0 with shears[custom_name={"color":"dark_gray","text":"Lacerate"},custom_data={vampAttack:true},use_effects={speed_multiplier:0.5,can_sprint:false},consumable={consume_seconds:999999999,animation:"spear"},enchantments={"under_pack:vamp/lunge":1}] 1
