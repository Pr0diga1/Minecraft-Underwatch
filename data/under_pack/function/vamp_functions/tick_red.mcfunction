...
execute as @a[tag=vampsucked,scores={vampsuck=8..},team=uBlue] run damage @s 3.5 player_attack by @a[limit=1,sort=nearest,team=uRed,scores={class=19}]
...
execute if score @s vampdetect matches -1 run function under_pack:vamp_functions/bat_die_red
