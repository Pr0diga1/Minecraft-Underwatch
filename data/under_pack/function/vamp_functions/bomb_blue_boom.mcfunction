...
execute at @e[tag=vampguy,tag=blue] run particle dust{color:[0.541,0.000,0.000],scale:1} ~ ~ ~ 1.5 1.5 1.5 1 100 normal
execute at @e[tag=vampguy,tag=blue] run particle crimson_spore ~ ~ ~ 1.5 1.5 1.5 1 100 normal
