scoreboard players set @s miku 0
...
execute if score @s class matches 14 as @s run function under_pack:miku/start

scoreboard players add miku classTotal 1
scoreboard players add @s TallyGun 1