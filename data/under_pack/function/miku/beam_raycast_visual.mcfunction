...
#particle
particle dust{color:[0.500,0.000,0.000],scale:0.6} ~ ~-0.2 ~ 0 0 0 0 0 normal
...
#execute if entity @s[team=uBlue] positioned ~-1 ~-1 ~-1 as @a[dx=2,dy=2,dz=2,team=uRed,limit=1,sort=nearest,gamemode=adventure] run function under_pack:miku/rifle_damage

#rerun command
execute if score @s movement matches ..100 positioned ^ ^ ^.5 run function under_pack:miku/beam_raycast_visual
