...
#hits a player
execute as @s[team=uRed] positioned ~-.5 ~-.5 ~-.5 as @a[dx=0,team=uBlue,limit=1,sort=nearest,gamemode=adventure] positioned ~0.5 ~0.5 ~0.5 if entity @s[dx=0] run return run function under_pack:miku/beam_damage
execute as @s[team=uBlue] positioned ~-.5 ~-.5 ~-.5 as @a[dx=0,team=uRed,limit=1,sort=nearest,gamemode=adventure] positioned ~0.5 ~0.5 ~0.5 if entity @s[dx=0] run return run function under_pack:miku/beam_damage
