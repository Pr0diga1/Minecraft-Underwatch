...
execute positioned ^ ^ ^1.5 positioned ~-1.5 ~-1.5 ~-1.5 if entity @s[team=uBlue] as @a[team=uRed,dx=3,dy=3,dz=3] run damage @s 4 arrow by @p[team=uBlue,scores={class=14}]
execute positioned ^ ^ ^1.5 positioned ~-1.5 ~-1.5 ~-1.5 if entity @s[team=uRed] as @a[team=uBlue,dx=3,dy=3,dz=3] run damage @s 4 arrow by @p[team=uRed,scores={class=14}]
