...
execute as @a[tag=park] run function under_pack:general_functions/general_classloop
...
execute as @a[tag=park,tag=uDead] run title @s actionbar {"text":"You died!","color":"gold"}
