...
#weaknessings
execute if score @s cyborghand matches 1 run item replace entity @s hotbar.0 with iron_block[custom_name='{"bold":true,"color":"dark_gray","text":"Metal Hand"}',custom_data={Tags:["cyborgsword"]},attribute_modifiers=[{id:"damage",type:"generic.attack_damage",amount:4,operation:"add_value"},{id:"armor",type:"generic.attack_speed",amount:-3,operation:"add_value"}]] 1
