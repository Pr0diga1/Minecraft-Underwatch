...
execute as @s[team=uRed] if entity @a[team=uBlue,distance=..5.25,gamemode=adventure] as @e[tag=CyborgZapGuy,type=marker,limit=1,sort=nearest] run tp @s ~ ~-.55 ~ facing entity @p[team=uBlue] eyes
execute as @s[team=uBlue] if entity @a[team=uRed,distance=..5.25,gamemode=adventure] as @e[tag=CyborgZapGuy,type=marker,limit=1,sort=nearest] run tp @s ~ ~-.55 ~ facing entity @p[team=uRed] eyes
