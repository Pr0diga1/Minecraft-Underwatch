...
item replace entity @s hotbar.3 with blaze_powder[consumable={consume_seconds:1,animation:"bow",sound:"block.blastfurnace.fire_crackle",on_consume_effects:[{type:"minecraft:play_sound",sound:"item.firecharge.use"}]},custom_data={immolation:true},use_cooldown={seconds:5},custom_name='{"bold":true,"color":"#FF8519","italic":false,"text":"Immolation"}'] 3
