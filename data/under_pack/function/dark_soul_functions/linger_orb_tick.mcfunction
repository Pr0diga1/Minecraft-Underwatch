...
execute if entity @s[scores={ability1=80}] run playsound minecraft:block.lava.extinguish master @a ~ ~ ~ 0.1 2

execute if entity @s[scores={ability1=50}] run particle minecraft:lava ~ ~ ~ 0 0 0 0.1 10
execute if entity @s[scores={ability1=50}] run playsound minecraft:block.lava.extinguish master @a ~ ~ ~ 1 2

execute if entity @s[scores={ability1=20}] run particle minecraft:lava ~ ~ ~ 0 0 0 0.1 10
execute if entity @s[scores={ability1=20}] run playsound minecraft:block.lava.extinguish master @a ~ ~ ~ 1 2

execute if entity @s[scores={ability1=15}] run particle minecraft:lava ~ ~ ~ 0 0 0 0.1 10
execute if entity @s[scores={ability1=15}] run playsound minecraft:block.lava.extinguish master @a ~ ~ ~ 0.5 1

execute if entity @s[scores={ability1=10}] run particle minecraft:lava ~ ~ ~ 0 0 0 0.1 10
execute if entity @s[scores={ability1=10}] run playsound minecraft:block.lava.extinguish master @a ~ ~ ~ 0.5 0.5

execute if entity @s[scores={ability1=9}] run particle minecraft:lava ~ ~ ~ 0 0 0 0.1 10
execute if entity @s[scores={ability1=8}] run particle minecraft:lava ~ ~ ~ 0 0 0 0.1 10
execute if entity @s[scores={ability1=7}] run particle minecraft:lava ~ ~ ~ 0 0 0 0.1 10
execute if entity @s[scores={ability1=6}] run particle minecraft:lava ~ ~ ~ 0 0 0 0.1 10
execute if entity @s[scores={ability1=5}] run particle minecraft:lava ~ ~ ~ 0 0 0 0.1 10
execute if entity @s[scores={ability1=9}] run playsound minecraft:item.flintandsteel.use master @a ~ ~ ~ 1 1
