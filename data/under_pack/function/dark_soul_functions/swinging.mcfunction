...
execute if entity @s[advancements={under_pack:dark_soul/swing_zwei=false}] run return 0
...
execute if score @s ability1 matches 1.. run return run advancement revoke @s only under_pack:dark_soul/swing_cooldown
...
advancement revoke @s only under_pack:dark_soul/swing_zwei
