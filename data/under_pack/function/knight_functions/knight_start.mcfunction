...
#grenade
item replace entity @s hotbar.2 with wind_charge[custom_name='{"color":"dark_green","text":"Holy Hand Grenade"}',custom_data={knightbomb:1b}] 1

#armor
item replace entity @s armor.chest with chainmail_chestplate[unbreakable={show_in_tooltip:false},attribute_modifiers={modifiers:[{id:"armor",type:"max_health",amount:10,operation:"add_value"}],show_in_tooltip:false}] 1
item replace entity @s armor.legs with iron_leggings[unbreakable={show_in_tooltip:false},attribute_modifiers=[{id:"scale",type:"scale",amount:0.3,operation:"add_value",slot:"any"}]]
