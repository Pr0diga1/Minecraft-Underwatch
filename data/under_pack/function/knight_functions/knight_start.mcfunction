...
item replace entity @s hotbar.0 with copper_ingot[custom_name={"color":"white","text":"Reliquary Blade"},lore=["Only given to those worthy"],custom_data={knightsword:1b},attribute_modifiers=[{id:"damage",type:"attack_damage",amount:3,operation:"add_value",slot:"mainhand"},{id:"speed",type:"attack_speed",amount:-3.35,operation:"add_value",slot:"mainhand"}],item_model="copper_sword",consumable={consume_seconds:999999,animation:"block"},attack_range={min_reach:0.0,max_reach:3.25,min_creative_reach:0.0,max_creative_reach:5.0,hitbox_margin:0.3}] 1
