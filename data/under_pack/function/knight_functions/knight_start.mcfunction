...
item replace entity @s hotbar.0 with copper_ingot[custom_name={"color":"white","text":"Reliquary Blade"},lore=["Only given to those worthy"],custom_data={knightsword:1b},attribute_modifiers=[{id:"damage",type:"attack_damage",amount:3.5,operation:"add_value",slot:"mainhand"},{id:"speed",type:"attack_speed",amount:-3.5,operation:"add_value",slot:"mainhand"}],item_model="golden_spear",consumable={consume_seconds:999999,animation:"block"},attack_range={min_reach:0.0,max_reach:4.0,min_creative_reach:0.0,max_creative_reach:5.0,hitbox_margin:0.4},piercing_weapon={deals_knockback:true,dismounts:true,sound:"item.spear.attack",hit_sound:"item.spear.hit"},swing_animation={duration:25,type:"stab"},minimum_attack_charge=1.0] 1
...
item replace entity @s armor.legs with iron_leggings[unbreakable={},attribute_modifiers=[{id:"scale",type:"scale",amount:0.5,operation:"add_value",slot:"any"},{id:"armor_leg",type:"armor",amount:5,operation:"add_value"}]] 1
