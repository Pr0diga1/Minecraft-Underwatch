...
item replace entity @s hotbar.0 with ender_eye[custom_name='{"color":"white","text":"Reliquary Blade"}',lore=['"Only given to those worthy"'],custom_model_data=3,custom_data={knightsword:1b},attribute_modifiers=[{id:"armor",type:"generic.attack_damage",amount:4,operation:"add_value",slot:"mainhand"},{id:"armor",type:"generic.attack_speed",amount:-2.9,operation:"add_value",slot:"mainhand"}]] 1
