...
## Acid Stuff
# Assigns stuff
execute as @e[type=potion,nbt={Item:{components:{"minecraft:custom_data":{acid:1b}}}}] run tag @s add acid
...
## Telepot stuff
# Assigns stuff
execute as @e[type=potion,tag=!telepot,nbt={Item:{components:{"minecraft:custom_data":{telepot:1b}}}}] run function under_pack:alchemist_functions/alchemist_velo
execute as @e[type=potion,tag=!telepot,nbt={Item:{components:{"minecraft:custom_data":{telepot:1b}}}}] run tag @s add telepot
...
## Healing pot stuff
# Assigns stuff
execute as @e[type=potion,nbt={Item:{components:{"minecraft:custom_data":{healing:1b}}}}] run tag @s add healing
...
execute if score @s ability2 matches 121.. unless entity @s[tag=!reload_utility] run item replace entity @s hotbar.1 with splash_potion[custom_name='{"bold":true,"color":"#BF5DC2","italic":false,"text":"Healing Solution"}',custom_model_data=3,custom_data={healing:1b},potion_contents={custom_color:16777215}] 1
...
execute if score @s movement matches 101.. unless entity @s[tag=!telepot_cooldown] run item replace entity @s hotbar.2 with splash_potion[custom_name='{"bold":true,"color":"#8753E0","italic":false,"text":"Telepot"}',custom_model_data=1,custom_data={telepot:1b},potion_contents={custom_color:16777215}] 1
