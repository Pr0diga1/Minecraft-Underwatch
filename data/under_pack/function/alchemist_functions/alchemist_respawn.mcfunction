...
execute as @e[nbt={potion_contents:{custom_effects:[{id:"minecraft:luck",duration:122}]}}] on origin if entity @s[gamemode=spectator] run kill @n[type=area_effect_cloud]
execute as @e[nbt={potion_contents:{custom_effects:[{id:"minecraft:luck",duration:121}]}}] on origin if entity @s[gamemode=spectator] run kill @n[type=area_effect_cloud]
