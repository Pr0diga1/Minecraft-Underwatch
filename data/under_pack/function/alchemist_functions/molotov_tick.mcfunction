...
execute if entity @s[tag=uBlue] as @a[team=uBlue,scores={class=1},distance=..3] run damage @s 1 magic by @s
execute if entity @s[tag=uRed] as @a[team=uRed,scores={class=1},distance=..3] run damage @s 1 magic by @s
