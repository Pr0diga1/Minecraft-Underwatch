...
execute at @e[type=marker,tag=acid,tag=uBlue] if entity @s[team=uBlue] run particle dust{color:[0.871,1.000,0.349],scale:1} 1 0 1 ~ ~.2 ~ 1 15 force @a
execute at @e[type=marker,tag=acid,tag=uRed] if entity @s[team=uRed] run particle dust{color:[0.871,1.000,0.349],scale:1} 1 0 1 ~ ~.2 ~ 1 15 force @a 
