...
execute if score @s movement matches 20 run item replace entity @s hotbar.1 with potato[custom_name="Jump on Cooldown"] 3
execute if score @s movement matches 40 run item replace entity @s hotbar.1 with potato[custom_name="Jump on Cooldown"] 2
execute if score @s movement matches 60 run item replace entity @s hotbar.1 with potato[custom_name="Jump on Cooldown"] 1
