...
#axe
item replace entity @s hotbar.0 with carrot_on_a_stick[custom_name={"bold":true,"color":"dark_gray","text":"Trusty Axe"},lore=[{"color":"dark_purple","text":"Simply Huge"}],unbreakable={},custom_data={lumberthrow:1b},attribute_modifiers=[{id:"armor",type:"attack_damage",amount:6,operation:"add_value",slot:"mainhand"},{id:"armor",type:"attack_speed",amount:-3.4,operation:"add_value",slot:"mainhand"}],item_model="stone_axe"] 1

#jump
item replace entity @s hotbar.1 with carrot_on_a_stick[custom_name={"color":"blue","text":"Strong Jump"},custom_data={lumberjump:1b},item_model="rabbit_foot"] 1
