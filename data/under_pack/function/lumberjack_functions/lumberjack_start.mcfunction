...
#axe
item replace entity @s hotbar.0 with carrot_on_a_stick[custom_name='{"bold":true,"color":"dark_gray","text":"Trusty Axe"}',lore=['{"color":"dark_purple","text":"Simply Huge"}'],unbreakable={},custom_model_data=28,custom_data={lumberthrow:1b},attribute_modifiers=[{id:"armor",type:"generic.attack_damage",amount:6,operation:"add_value",slot:"mainhand"},{id:"armor",type:"generic.attack_speed",amount:-3.4,operation:"add_value",slot:"mainhand"}]] 1
